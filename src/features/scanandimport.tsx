...
const ScanAndImport = ({ navigation }) => {
  ...
  const handleScanPress = () => {
    ...
    navigation.navigate('CheckCamera',{backpage:'ScanAndImport'});
  };

  const handleImportPress = () => {
    navigation.navigate('ImportImage',{backpage:'ScanAndImport'});
  };
